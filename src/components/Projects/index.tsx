            ...
            <SwiperSlide key={repo.id} className="flex h-auto">
              ...
              >
                <div className="flex flex-col items-center">
                  <div
                    className={`flex h-48 w-full items-center justify-center overflow-hidden ${darkMode ? 'dark:bg-gray-700' : 'bg-gray-100'}`}
                  >
                    <img
                ...
                <div className="flex flex-grow flex-col p-6">
                  ...
                  {topics.length > 0 && (
                    <div className="mb-4 flex flex-wrap gap-2 select-none">
                      {repo.language && (
                        <span
                          className={`rounded-full ${darkMode ? 'bg-gray-700 text-white' : 'bg-gray-100 text-gray-800'} px-3 py-1 text-xs`}
                        >
                          {repo.language}
                        </span>
                      )}
                  ...
                  <div className="mt-auto flex gap-3">
                    ...
                    {link && (
                      <a
                        ...
                        } flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-transform select-none hover:scale-105`}
                      >
